...
export default async function EditarItemCubiertaPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const update = updateItem.bind(null, "cubierta", id);
  const remove = deleteItem.bind(null, "cubierta", id);
    ...
    <div>
      <div className="flex-between mb16">
        ...
        <div className="flex-gap">
          <Link href={`/inventario/cubierta/${id}/movimiento`} className="btn btn-ghost btn-sm">
            Reportar cambio
          </Link>
          <form action={remove}>
